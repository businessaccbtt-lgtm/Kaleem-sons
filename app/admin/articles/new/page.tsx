        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}>
          ...
          <div style={{ ...cardStyle, display: "flex", flexDirection: "column", gap: "1rem" }}>
            <div>
              ...
              <input style={inputStyle} value={form.title}
                ...
                placeholder="How to Choose the Right Sportswear" />
            </div>
            <div>
              <label style={labelStyle}>Slug *</label>
              <input style={inputStyle} value={form.slug}
                onChange={e => setForm(f => ({ ...f, slug: e.target.value }))}
                placeholder="how-to-choose-right-sportswear" />
          ...
          <div style={cardStyle}>
            ...
            <div style={{
              ...
              background: "#fafafa", fontSize: "0.9rem", lineHeight: 1.7,
              cursor: "text",
            }}
...
function EditorToolbar({ editor }: { editor: ReturnType<typeof useEditor> }) {
  ...
  return (
    <div style={{ display: "flex", flexWrap: "wrap", gap: "0.35rem", marginBottom: "0.75rem" }}>
      ...
      {btn(false, () => editor.chain().focus().setHardBreak().run(), "↵ Break")}
      <div style={{ width: "1px", background: "#ddd", margin: "0 0.25rem" }} />
